...
@Getter				//필드에 대한 getter를 자동생성 함
@Setter				//필드에 대한 setter를 자동생성 함
@NoArgsConstructor	//기본생성자를 자동 생성해줌	HelloLombok(){}
...
public class HelloLombok {
	...
	public static void main(String[] args) {
		...
		//위에 생성된 클래스의 내용과 롬북이 잘 적용되었는지 확인
		//객체 생성 -> 객체 내부의 필드와 메소드를 사용할 수 있음.
		...
		//toString() 메소드 호출
		System.out.println(lombok);		//객체출력 
